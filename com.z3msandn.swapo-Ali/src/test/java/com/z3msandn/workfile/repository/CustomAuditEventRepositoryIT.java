...
import com.z3msandn.workfile.config.audit.AuditEventConverter;
import com.z3msandn.workfile.domain.PersistentAuditEvent;
...
import static com.z3msandn.workfile.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
