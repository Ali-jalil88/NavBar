...
import com.z3msandn.workfile.WorkfileApp;
import com.z3msandn.workfile.config.Constants;
import com.z3msandn.workfile.domain.User;
import com.z3msandn.workfile.repository.AuthorityRepository;
import com.z3msandn.workfile.repository.UserRepository;
import com.z3msandn.workfile.security.AuthoritiesConstants;
import com.z3msandn.workfile.service.UserService;
import com.z3msandn.workfile.service.dto.PasswordChangeDTO;
import com.z3msandn.workfile.service.dto.UserDTO;
import com.z3msandn.workfile.web.rest.vm.KeyAndPasswordVM;
import com.z3msandn.workfile.web.rest.vm.ManagedUserVM;
...
import static com.z3msandn.workfile.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = WorkfileApp.class)
